...
if (__vue_script__ &&
  ...
  console.warn("[vue-loader] source/vue/views/main.vue: named exports in *.vue files are ignored.")}
...
module.exports = "\n\t<div id=\"dashboard\" class=\"dashboard\">\n\t\t<h1>dashboard</h1>\n\t\t<h2>{{vue1}}</h2>\n\t\t<h2>{{vue2}}</h2>\n    \t<button>Clear all CSS rules</button>\n\t</div>\n";

/***/ },
/* 12 */
/***/ function(module, exports) {

module.exports = "\n<div style=\"display:none\">\n\t<div id=\"icToggle\" style=\"display:none\">\n\t\t<div class=\"_icToggleContent\">\n\t\t\t<div class=\"_icToggleImg\"></div>\n\t\t</div>\n\t</div>\n\t<div id=\"icContentPanel\">\n\t\t <router-view class=\"icContent\" keep-alive transition transition-mode=\"out-in\"></router-view>\n\t</div>\n</div>\n";
...
if (__vue_script__ &&
    __vue_script__.__esModule &&
    Object.keys(__vue_script__).length > 1) {
  console.warn("[vue-loader] source/vue/views/dashboard.vue: named exports in *.vue files are ignored.")}
...
/* Vue routing */ 
function initVue(){
	var icRouterConfig = __webpack_require__(6);
	...
	/* Setup global app */
	var main = vue.extend(__webpack_require__(4));
