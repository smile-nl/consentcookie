...
var icookieContent = null;

/* State variables */
window.icookieLoaded = (typeof(icookieLoaded) != "undefined" ? icookieLoaded : false);
...
function init() {	
    ...
    initDependencies();
    initUI();
    console.log("icookieloaded=true");
    icookieLoaded = true;
};
